...
async def create_blog(blog: CreateBlog, db: Session = Depends(get_db)) -> CreateBlog:
    """
    Route method to create blog.
    """
...
def get_blog(id: int, db: Session = Depends(get_db)) -> ShowBlog:
    """
    Route method to create get blog.
    """
...
def get_all_blogs(db: Session = Depends(get_db)) -> list[ShowBlog]:
    """
    Route method to get all blogs.
    """
